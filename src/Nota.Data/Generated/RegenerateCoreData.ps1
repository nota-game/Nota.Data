...
.\tools\xscgen.exe -0 --namespace=http://nota-game.azurewebsites.net/schema/nota=Core --prefix=Nota.Data.Generated https://nota-game.azurewebsites.net/schema/nota.xsd http://nota-game.azurewebsites.net/schema/misc.xsd http://nota-game.azurewebsites.net/schema/lebewesen.xsd http://nota-game.azurewebsites.net/schema/kultur.xsd http://nota-game.azurewebsites.net/schema/profession.xsd http://nota-game.azurewebsites.net/schema/talent.xsd http://nota-game.azurewebsites.net/schema/fertigkeit.xsd http://nota-game.azurewebsites.net/schema/besonderheit.xsd http://nota-game.azurewebsites.net/schema/kampf/aktionen.xsd http://nota-game.azurewebsites.net/schema/kampf/ausstattung.xsd
